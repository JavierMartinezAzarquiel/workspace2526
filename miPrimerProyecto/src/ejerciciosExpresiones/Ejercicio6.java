...
public class Ejercicio6 {
	...
	public static void main(String[] args) {
		/*
		 * Realiza un programa que cuando un cliente de un banco quiere sacar una cantidad de dinero de su cuenta, calcule cuántos billetes tenemos que darle. Siempre calcularemos la mínima cantidad de billetes.
		...
		System.out.print("Teclea la cantidar de euros: ");
