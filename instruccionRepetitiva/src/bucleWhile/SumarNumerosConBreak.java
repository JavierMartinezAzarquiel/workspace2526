...
public class SumarNumerosConBreak {
	...
	public static void main(String[] args) {
		...
		do { //uso un do-while porque como minimo tendré que pedir un número
			...
			if (numero == 0) {  //si el número es cero, rompo el bucle
				break;
			}
		...
		} while (true);  //ya no necesito condición, el bucle lo parará el break
