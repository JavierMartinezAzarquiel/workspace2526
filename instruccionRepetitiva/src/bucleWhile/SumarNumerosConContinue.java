...
public class SumarNumerosConContinue {

	public static void main(String[] args) {
		/*
		 * Pedir números hasta que ponemos un 0
		 * Imprimimos como resultado la suma de todos ellos.
		 * Solo contamos y sumamos los número positivos, los negativos no
		 * Lo vamos a programar con un CONTINUE
		 */
		...
		do { //uso un do-while porque como minimo tendré que pedir un número
			...
			if (numero < 0 ) { //si es negativo, paso de el
				continue;
			}
